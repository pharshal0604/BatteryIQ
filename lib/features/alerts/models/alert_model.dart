...
class AlertModel with _$AlertModel {
  ...
  static List<AlertModel> mockList() => [
        ...
        const AlertModel(
          ...
          severity:  'CRITICAL',
          type:      'TEMPERATURE',
          message:   'Battery temperature exceeded 45°C during last charge cycle.',
...
extension AlertModelExtension on AlertModel {
  ...
  IconData get typeIcon {
    switch (type) {
      case 'SOH':         return Icons.battery_alert_rounded;
      case 'TEMPERATURE': return Icons.thermostat_rounded;
      case 'CYCLES':      return Icons.loop_rounded;
      case 'STRESS':      return Icons.speed_rounded;
      case 'REGEN':       return Icons.replay_rounded;
  ...
  String get typeLabel {
    switch (type) {
      case 'SOH':         return 'Battery Health';
      case 'TEMPERATURE': return 'Temperature';
      case 'CYCLES':      return 'Charge Cycles';
      case 'STRESS':      return 'Driving Stress';
